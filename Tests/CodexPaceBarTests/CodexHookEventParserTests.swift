...
struct CodexHookEventParserTests {
    @Test
    func mapsSubmittedPromptToWorkingInsteadOfQueued() {
        let input = """
        {"session_id":"session","turn_id":"turn","cwd":"/work/project","hook_event_name":"UserPromptSubmit","generated_at":1784372000}
        """
